...
const noConnectionMessage = `No connection to browser extension. In order to proceed, you must first connect a tab by clicking the Autobrowser extension icon in the browser toolbar and clicking the 'Connect' button.`;
